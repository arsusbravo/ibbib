        ...
        <div class="media-body additem-work">
            ...
            <div id="addhistory" class="additem">
                ...
                <div class="code-edit-small">
                    ...
                    <input class="form-control" name="co_name">
    ...
    <li class="education-background">
        ...
        <div class="media-body additem-edu">
            ...
            <div id="add-edu" class="additem">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="rating-star">
                            <div class="rating">
                                ...
                                <input type="radio" id="star2" name="rating"><label class="full" for="star2"></label>
                                <input type="radio" id="star3" name="rating"><label class="full" for="star3"></label>
                                <input type="radio" id="star4" name="rating"><label class="full" for="star4"></label>
                ...
                <label>{{ __('Description') }}</label>
                <textarea class="form-control" placeholder="{{ __('Description') }}"></textarea>
            </div><!-- /.additem -->
        </div>
    </li><!-- /.personal-deatils -->
...
<div class="buttons pull-right">
    <a href="#" class="btn button-cancle">Cancel</a>
