...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        <meta charset="utf-8">
        <title>
            {{ \Auth::user()->role->name }} - {{ config('app.name', 'ARSUS manager') }}
        </title>
    ...
    <body class="mod-bg-1 ">
            ...
            <div class="page-inner">
                ...
                <aside class="page-sidebar">
                    <div class="page-logo">
                        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                            <img src="{{ url('themes/dashboard/img/logo.png') }}" alt="{{ config('app.name', 'ARSUS manager') }}" aria-roledescription="logo" class="img-logo">
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <div class="info-card">
                            <img src="{{ url('themes/dashboard/img/demo/avatars/avatar-admin.png') }}" class="profile-image rounded-circle" alt="{{ \Auth::user()->name }}">
                            <div class="info-card-text">
                                ...
                                <span class="d-inline-block text-truncate text-truncate-sm">{{ \Auth::user()->role->name }}</span>
                            </div>
                            <img src="{{ url('themes/dashboard/img/card-backgrounds/cover-2-lg.png') }}" class="cover" alt="cover">
                ...
                <div class="page-content-wrapper">
                    ...
                    <header class="page-header" role="banner">
                        ...
                        <div class="page-logo">
                            <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                                <img src="{{ url('themes/dashboard/img/logo.png') }}" alt="SmartAdmin WebApp" aria-roledescription="logo">
                        ...
                        <div class="ml-auto d-flex">
                                            ...
                                            <div class="custom-scroll h-100">
                                                <ul class="notification">
                                                    <li class="unread">
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ url('themes/dashboard/img/demo/avatars/avatar-c.png') }}')"></span>
                                                            </span>
                                                    ...
                                                    <li class="unread">
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ url('themes/dashboard/img/demo/avatars/avatar-a.png') }}')"></span>
                                                            </span>
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                                    ...
                                                    <li>
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-success mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ url('themes/dashboard/img/demo/avatars/avatar-b.png') }}')"></span>
                                                            </span>
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                                    ...
                                                    <li>
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-warning mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ url('themes/dashboard/img/demo/avatars/avatar-e.png') }}')"></span>
                                                            </span>
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                                    ...
                                                    <li>
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-success mr-2">
                                                                <!-- <img src="{{ url('themes/dashboard/img/demo/avatars/avatar-m.png') }}" data-src="{{ url('themes/dashboard/img/demo/avatars/avatar-h.png') }}" class="profile-image rounded-circle" alt="Sarah McBrook" /> -->
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ url('themes/dashboard/img/demo/avatars/avatar-h.png') }}')"></span>
                                                            </span>
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                                    ...
                                                    <li>
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-success mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ url('themes/dashboard/img/demo/avatars/avatar-m.png') }}')"></span>
                                                            </span>
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                                    ...
                                                    <li>
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-danger mr-2">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('{{ url('themes/dashboard/img/demo/avatars/avatar-j.png') }}')"></span>
                                                            </span>
                                                            <span class="d-flex flex-column flex-1 ml-1">
                                        ...
                                        <div class="tab-pane" id="tab-feeds" role="tabpanel">
                                            <div class="custom-scroll h-100">
                                                <ul class="notification">
                                                    ...
                                                    <li>
                                                        <div class="d-flex align-items-center show-child-on-hover">
                                                            <!--<img src="{{ url('themes/dashboard/img/demo/avatars/avatar-m.png') }}" data-src="{{ url('themes/dashboard/img/demo/avatars/avatar-k.png') }}" class="profile-image rounded-circle" alt="k" />-->
                                                            <div class="d-flex flex-column flex-1">
                                                                <span class="name">
                                                                    Troy Norman'<span class="fw-300">s new connections</span>
                                                                </span>
                                                                <div class="fs-sm d-flex align-items-center mt-2">
                                                                    <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('{{ url('themes/dashboard/img/demo/avatars/avatar-a.png') }}'); background-size: cover;"></span>
                                                                    <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('{{ url('themes/dashboard/img/demo/avatars/avatar-b.png') }}'); background-size: cover;"></span>
                                                                    <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('{{ url('themes/dashboard/img/demo/avatars/avatar-c.png') }}'); background-size: cover;"></span>
                                                                    <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('{{ url('themes/dashboard/img/demo/avatars/avatar-e.png') }}'); background-size: cover;"></span>
                                                                    <div data-hasmore="+3" class="rounded-circle profile-image-md mr-1">
                                                                        <span class="profile-image-md mr-1 rounded-circle d-inline-block" style="background-image:url('{{ url('themes/dashboard/img/demo/avatars/avatar-h.png') }}'); background-size: cover;"></span>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <li>
                                                        <div class="d-flex align-items-center show-child-on-hover">
                                                            <!--<img src="{{ url('themes/dashboard/img/demo/avatars/avatar-m.png') }}" data-src="{{ url('themes/dashboard/img/demo/avatars/avatar-e.png') }}" class="profile-image-sm rounded-circle align-self-start mt-1" alt="k" />-->
                                                            <div class="d-flex flex-column flex-1">
                                                            ...
                                                            <div class="d-flex flex-column flex-1">
                                                                ...
                                                                <div class="fs-sm d-flex align-items-center mt-1">
                                                                    <a href="#" class="mr-1 mt-1" title="Cell A-0012">
                                                                        <span class="d-block img-share" style="background-image:url('{{ url('themes/dashboard/img/thumbs/pic-7.png') }}'); background-size: cover;"></span>
                                                                    </a>
                                                                    <a href="#" class="mr-1 mt-1" title="Patient A-473 saliva">
                                                                        <span class="d-block img-share" style="background-image:url('{{ url('themes/dashboard/img/thumbs/pic-8.png') }}'); background-size: cover;"></span>
                                                                    </a>
                                                                    <a href="#" class="mr-1 mt-1" title="Patient A-473 blood cells">
                                                                        <span class="d-block img-share" style="background-image:url('{{ url('themes/dashboard/img/thumbs/pic-11.png') }}'); background-size: cover;"></span>
                                                                    </a>
                                                                    <a href="#" class="mr-1 mt-1" title="Patient A-473 Membrane O.C">
                                                                        <span class="d-block img-share" style="background-image:url('{{ url('themes/dashboard/img/thumbs/pic-12.png') }}'); background-size: cover;"></span>
                                                                    </a>
                                                                </div>
                                                                <span class="fs-nano text-muted mt-1">55 minutes ago</span>
                                                            </div>
                                                    ...
                                                    <li>
                                                        <div class="d-flex align-items-center show-child-on-hover">
                                                            <!--<img src="{{ url('themes/dashboard/img/demo/avatars/avatar-m.png') }}" data-src="{{ url('themes/dashboard/img/demo/avatars/avatar-h.png') }}" class="profile-image rounded-circle align-self-start mt-1" alt="k" />-->
                                                            <div class="d-flex flex-column flex-1">
                                                                <div class="name mb-2">
                            ...
                            <div>
                                <a href="#" data-toggle="dropdown" title="drlantern@gotbootstrap.com" class="header-icon d-flex align-items-center justify-content-center ml-2">
                                    <img src="{{ url('themes/dashboard/img/demo/avatars/avatar-admin.png') }}" class="profile-image rounded-circle" alt="Dr. Codex Lantern">
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="{{ url('themes/dashboard/img/demo/avatars/avatar-admin.png') }}" class="rounded-circle profile-image" alt="{!! \Auth::user()->name !!}">
                                            </span>
                                            <div class="info-card-text">
                                    ...
                                    <a href="{{ url('/') }}" target="_blank" class="dropdown-item">
                                        <span data-i18n="drpdwn.reset_layout">{{ __('Frontpage') }}</span>
                                    </a>
                                    <div class="dropdown-divider m-0"></div>
                    ...
                    <footer class="page-footer" role="contentinfo">
                        <div class="d-flex align-items-center flex-1 text-muted">
                            <span class="hidden-md-down fw-700">2020 © {{ config('app.name', 'ARSUS manager') }}</span>
                        </div>
                        <div>
        ...
        <script src="{{ url('themes/dashboard/js/vendors.bundle.js') }}"></script>
        <script src="{{ url('themes/dashboard/js/app.bundle.js') }}"></script>
        @yield('script-bottom')
    </body>
</html>