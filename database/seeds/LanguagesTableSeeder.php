...
class LanguagesTableSeeder extends Seeder
{
    ...
    {
        $data = [
            ['name' => 'English', 'original' => 'English', 'code' => 'en', 'country_id' => 231, 'active' => 1],
            ['name' => 'Dutch', 'original' => 'Nederlands', 'code' => 'nl', 'country_id' => 156, 'active' => 1],
            ['name' => 'Italian', 'original' => 'Italiano', 'code' => 'it', 'country_id' => 107, 'active' => 1],
            ['name' => 'Indonesian', 'original' => 'Bahasa Indonesia', 'code' => 'id', 'country_id' => 102, 'active' => 1],
            ['name' => 'German', 'original' => 'Deutsch', 'code' => 'de', 'country_id' => 81, 'active' => 1],
            ['name' => 'Afar', 'code' => 'aa'],
